...
@interface ActionSheetBottom () {
    int tag;
}

@property (nonatomic, weak) ActionSheetBottom *actionSheet;
...
@implementation ActionSheetBottom
...
- (instancetype)initWithDelegate:(id<ActionSheetBottomDelegate>)delegate
    ...
    ActionSheetBottom *actionSheet = [self init];
